...
; http://www.autohotkey.com/board/topic/7169-auto-syntax-tidy-v12/
...
ReadSyntaxFiles:
  ...
  PathSyntaxFiles = C:\Users\The_M\OneDrive\Desktop
  ...
  CommandNamesFile = CommandNames.txt
  ...
  FileRead, Variables, *t Variables.txt
...
FileRead, codeFromFile, codeFromFile.txt

  ;Cut highlight to clipboard
  Clipboard := codeFromFile
  ...
  Else {
      ...
      ;paste clipboard
      FileDelete, formatedCode.txt
      FileAppend, %Clipboard%, formatedCode.txt
      ;restore the original clipboard and free memory
      Clipboard := ClipSaved
      ClipSaved =
